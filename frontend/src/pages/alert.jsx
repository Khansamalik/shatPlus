          ...
          <div className="bg-white rounded-2xl shadow-lg border border-[#f0f0f0] overflow-hidden transition-all hover:shadow-xl">
            <div className="bg-gradient-to-r from-[#8B0000] to-[#a00000] p-6">
              <div className="flex items-center">
                ...
                <h2 className="text-2xl font-bold text-white">Call an Ambulance</h2>
              </div>
            </div>
            <div className="p-6">
              <div className="mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button 
                  onClick={handleSendAlert}//not sure what the action shud be rn backend kr k change
            ...
            <div className="p-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-16">
                ...
                <button
                  ...
                  className="flex-1 bg-white border border-[#8B0000] to-[#a00000] text-[#8B0000] py-3 px-6 rounded-lg font-medium hover:bg-[#f0f7ff] transition flex items-center justify-center gap-2">
                  <MapPin size={18} />
                  Get Directions
                </button>
              </div>
